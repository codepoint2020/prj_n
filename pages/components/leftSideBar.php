                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="panel.php?load_gallery=true" class="sidebar-link"><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="panel.php?update_profile=true&user_id=<?php echo  $_SESSION['user_id']; ?>" class="sidebar-link"><span
                                            class="hide-menu"> Account Settings
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="panel.php?profile=true&user_id=<?php echo $_SESSION['user_id']; ?>" class="sidebar-link"><span
