...
<div class="row card-parent">
     <!-- column -->
     <div class="col-lg-2 d-flex align-content-stretch card-handle">
        <!-- Card -->
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">The HyperText Markup Language or HTML is the standard markup language for documents designed to be displayed in a web browser. <a href="#">Read more</a> </p>
            </div>
        </div>
        <!-- Card -->
    </div>
    ...
    <div class="col-lg-2 d-flex align-content-stretch card-handle">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Cascading Style Sheets is a style sheet language used for describing the presentation of a document written in a markup language such as HTML or XML.<a href="#"> Read more</a></p>
            </div>
        </div>
        <!-- Card -->
    </div>
    ...
    <div class="col-lg-2 d-flex align-content-stretch card-handle">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">JavaScript, often abbreviated as JS, is a programming language that is one of the core technologies of the World Wide Web, alongside HTML and CSS.<a href="#"> Read more</a></p>
            </div>
        </div>
        <!-- Card -->
    </div>
    ...
    <div class="col-lg-2 d-flex align-content-stretch card-handle">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">PHP is a general-purpose scripting language geared toward web development. It was originally created by Danish-Canadian programmer Rasmus Lerdorf in 1993 and released in 1995.<a href="#"> Read more</a></p>
            </div>
        </div>
        <!-- Card -->
    </div>
    ...
    <div class="col-lg-2 d-flex align-content-stretch card-handle">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">MySQL is an open-source relational database management system.<a href="#"> Read more</a></p>
            </div>
        </div>
        <!-- Card -->
    </div>
    ...
    <div class="col-lg-2 d-flex align-content-stretch card-handle">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Bootstrap is a free and open-source CSS framework directed at responsive, mobile-first front-end web development.<a href="#"> Read more</a></p>
            </div>
        </div>
        <!-- Card -->
    </div>
